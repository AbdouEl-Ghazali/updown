...
const Metric = ({metric, color, children}: any) => {
  return (
    <div className={`grid grid-cols-2 justify-items-start place-items-center mx-5 pl-10 gap-10 w-full max-w-xs min-w-[250px] h-24 rounded-xl bg-zinc-200 bg-opacity-50 dark:bg-zinc-700`}>
